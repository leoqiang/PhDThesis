...
%% Fig. \ref{fig:workflow-distiller-colombos}).  The promoter regions of the
...
%Distiller' button is disabled (Fig.  \ref{fig:distiller}).  Users must first
...
Here, we demonstrate this step using the correspoding sample files, the
